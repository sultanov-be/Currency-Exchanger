...
import com.example.currencyexchanger.repository.MainDefaultRepository
...
object AppModule {
    ...
    @Singleton
    @Provides
    fun provideMainRepository(api: CurrencyApi): MainRepository = MainDefaultRepository(api)
